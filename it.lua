...
local YourLang = "it" -- Language code that the messages are going to be translated to
...
game:GetService("StarterGui"):SetCore("SendNotification",
    {
        Title = "Traduttore Di Chat (V0.01)",
        Text = "Bug Fixati.",
        Duration = 3
    }
)
                  
properties.Text = "[TRADUTTORE] Per mandare messaggi in altre lingue, scrivi > seguito dal target del linguaggio (in inglese) o codice linguaggio (sempre in inglese), es: >ru o >russian. Per disabilitare (andando indietro al linguaggio normale), dire >d."
